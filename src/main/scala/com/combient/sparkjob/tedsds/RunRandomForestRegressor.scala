...
object RunRandomForestRegressor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val parser = new OptionParser[Params]("RunRandomForestRegressor") {
      ...
      note(
        """
          ...
          |
          | bin/spark-submit --class com.combient.sparkjob.tedsds.RunRandomForestRegressor \
          |  jarfile.jar \
  ...
  def run(params: Params) {
    ...
    val conf = new SparkConf().setAppName(s"RunRandomForestRegressor with $params")
    ...
    val model: RandomForestModel = RandomForest.trainRegressor(trainRDD, numClasses,
